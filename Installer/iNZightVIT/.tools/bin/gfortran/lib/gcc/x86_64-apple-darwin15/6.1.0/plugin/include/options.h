...
enum opt_code
{
  ...
  OPT_aux_info = 507,                        /* -aux-info */
  /* OPT_aux_info_ = 508, */                 /* -aux-info= */
  OPT_auxbase = 509,                         /* -auxbase */
  OPT_auxbase_strip = 510,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 511, */              /* -bind_at_load */
  /* OPT_bootclasspath = 512, */             /* -bootclasspath */
  /* OPT_bundle = 513, */                    /* -bundle */
  /* OPT_bundle_loader = 514, */             /* -bundle_loader */
  OPT_c = 515,                               /* -c */
  /* OPT_classpath = 516, */                 /* -classpath */
  OPT_client_name = 517,                     /* -client_name */
  OPT_compatibility_version = 518,           /* -compatibility_version */
  OPT_coverage = 519,                        /* -coverage */
  OPT_cpp = 520,                             /* -cpp */
  OPT_cpp_ = 521,                            /* -cpp= */
  OPT_current_version = 522,                 /* -current_version */
  OPT_d = 523,                               /* -d */
  /* OPT_dead_strip = 524, */                /* -dead_strip */
  /* OPT_dependency_file = 525, */           /* -dependency-file */
  OPT_dumpbase = 526,                        /* -dumpbase */
  OPT_dumpdir = 527,                         /* -dumpdir */
  OPT_dumpmachine = 528,                     /* -dumpmachine */
  OPT_dumpspecs = 529,                       /* -dumpspecs */
  OPT_dumpversion = 530,                     /* -dumpversion */
  /* OPT_dylib_file = 531, */                /* -dylib_file */
  OPT_dylinker = 532,                        /* -dylinker */
  OPT_dylinker_install_name = 533,           /* -dylinker_install_name */
  /* OPT_dynamic = 534, */                   /* -dynamic */
  /* OPT_dynamiclib = 535, */                /* -dynamiclib */
  OPT_e = 536,                               /* -e */
  /* OPT_encoding = 537, */                  /* -encoding */
  OPT_export_dynamic = 538,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 539, */     /* -exported_symbols_list */
  OPT_extdirs = 540,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 541, */               /* -fCLASSPATH= */
  OPT_fPIC = 542,                            /* -fPIC */
  OPT_fPIE = 543,                            /* -fPIE */
  OPT_fRTS_ = 544,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 545,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 546,                   /* -fabi-version= */
  OPT_faccess_control = 547,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 548,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 549,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 550,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 551,                  /* -falign-commons */
  OPT_falign_functions = 552,                /* -falign-functions */
  OPT_falign_functions_ = 553,               /* -falign-functions= */
  OPT_falign_jumps = 554,                    /* -falign-jumps */
  OPT_falign_jumps_ = 555,                   /* -falign-jumps= */
  OPT_falign_labels = 556,                   /* -falign-labels */
  OPT_falign_labels_ = 557,                  /* -falign-labels= */
  OPT_falign_loops = 558,                    /* -falign-loops */
  OPT_falign_loops_ = 559,                   /* -falign-loops= */
  OPT_fall_intrinsics = 560,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 561, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 562,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 563,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 564, */   /* -falt-external-templates */
  OPT_fapple_kext = 565,                     /* -fapple-kext */
  /* OPT_fargument_alias = 566, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 567, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 568, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 569, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 570,            /* -fasan-shadow-offset= */
  OPT_fasm = 571,                            /* -fasm */
  OPT_fassert = 572,                         /* -fassert */
  OPT_fassociative_math = 573,               /* -fassociative-math */
  OPT_fassume_compiled = 574,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 575,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 576,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 577,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 578,                   /* -fauto-profile */
  OPT_fauto_profile_ = 579,                  /* -fauto-profile= */
  OPT_fautomatic = 580,                      /* -fautomatic */
  OPT_faux_classpath = 581,                  /* -faux-classpath */
  OPT_fbackslash = 582,                      /* -fbackslash */
  OPT_fbacktrace = 583,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 584,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 585,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 586,              /* -fbootstrap-classes */
  OPT_fbounds_check = 587,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 588,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 589,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 590,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 591,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 592,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 593,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 594,                        /* -fbuiltin */
  OPT_fbuiltin_ = 595,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 596,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 597,                    /* -fcall-saved- */
  OPT_fcall_used_ = 598,                     /* -fcall-used- */
  OPT_fcaller_saves = 599,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 600,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 601,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 602,                /* -fcheck-data-deps */
  OPT_fcheck_new = 603,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 604,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 605,               /* -fcheck-references */
  OPT_fcheck_ = 606,                         /* -fcheck= */
  OPT_fchecking = 607,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 608,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 609,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 610,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 611,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 612,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 613,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 614,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 615, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 616,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 617,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 618,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 619, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 620,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 621,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 622,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 623,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 624,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 625,                       /* -fcilkplus */
  OPT_fclasspath_ = 626,                     /* -fclasspath= */
  OPT_fcoarray_ = 627,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 628,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 629,                         /* -fcommon */
  OPT_fcompare_debug = 630,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 631,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 632,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 633,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 634,              /* -fcompile-resource= */
  OPT_fconcepts = 635,                       /* -fconcepts */
  OPT_fcond_mismatch = 636,                  /* -fcond-mismatch */
  OPT_fconserve_space = 637,                 /* -fconserve-space */
  OPT_fconserve_stack = 638,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 639,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 640,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 641,                       /* -fconvert= */
  OPT_fcprop_registers = 642,                /* -fcprop-registers */
  OPT_fcray_pointer = 643,                   /* -fcray-pointer */
  OPT_fcrossjumping = 644,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 645,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 646, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 647,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 648,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 649,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 650,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 651,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 652,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 653,                       /* -fdbg-cnt= */
  OPT_fdce = 654,                            /* -fdce */
  OPT_fdebug_cpp = 655,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 656,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 657,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 658,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 659,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 660,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 661, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 662,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 663,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 664,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 665,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 666,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 667,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 668,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 669,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 670,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 671, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 672,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 673,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 674,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 675,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 676,                /* -fdirectives-only */
  OPT_fdisable_ = 677,                       /* -fdisable- */
  OPT_fdisable_assertions = 678,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 679,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 680,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 681,         /* -fdollars-in-identifiers */
  OPT_fdse = 682,                            /* -fdse */
  OPT_fdump_ = 683,                          /* -fdump- */
  OPT_fdump_ada_spec = 684,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 685,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 686, */                /* -fdump-core */
  OPT_fdump_final_insns = 687,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 688,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 689,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 690,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 691,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 692,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 693,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 694, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 695,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 696,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 697,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 698,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 699,                 /* -fearly-inlining */
  OPT_felide_constructors = 700,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 701,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 702, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 703,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 704,        /* -femit-class-debug-always */
  OPT_femit_class_file = 705,                /* -femit-class-file */
  OPT_femit_class_files = 706,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 707,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 708,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 709,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 710,                        /* -fenable- */
  OPT_fenable_assertions = 711,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 712,             /* -fenable-assertions= */
  OPT_fencoding_ = 713,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 714,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 715, */           /* -fenum-int-equiv */
  OPT_fexceptions = 716,                     /* -fexceptions */
  OPT_fexcess_precision_ = 717,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 718,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 719,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 720,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 721,                       /* -fextdirs= */
  OPT_fextended_identifiers = 722,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 723,                /* -fextern-tls-init */
  OPT_fexternal_blas = 724,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 725, */       /* -fexternal-templates */
  OPT_ff2c = 726,                            /* -ff2c */
  OPT_ffast_math = 727,                      /* -ffast-math */
  OPT_ffat_lto_objects = 728,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 729,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 730,               /* -ffinite-math-only */
  OPT_ffixed_ = 731,                         /* -ffixed- */
  OPT_ffixed_form = 732,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 733,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 734,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 735,                    /* -ffloat-store */
  OPT_ffor_scope = 736,                      /* -ffor-scope */
  /* OPT_fforce_addr = 737, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 738,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 739,              /* -fforward-propagate */
  OPT_ffp_contract_ = 740,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 741,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 742,                      /* -ffpe-trap= */
  OPT_ffree_form = 743,                      /* -ffree-form */
  OPT_ffree_line_length_ = 744,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 745,          /* -ffree-line-length-none */
  OPT_ffreestanding = 746,                   /* -ffreestanding */
  OPT_ffriend_injection = 747,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 748,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 749,                   /* -ffunction-cse */
  OPT_ffunction_sections = 750,              /* -ffunction-sections */
  OPT_fgcse = 751,                           /* -fgcse */
  OPT_fgcse_after_reload = 752,              /* -fgcse-after-reload */
  OPT_fgcse_las = 753,                       /* -fgcse-las */
  OPT_fgcse_lm = 754,                        /* -fgcse-lm */
  OPT_fgcse_sm = 755,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 756,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 757,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 758,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 759,                         /* -fgnu-tm */
  OPT_fgnu_unique = 760,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 761,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 762,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 763,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 764,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 765,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 766,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 767,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 768,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 769,                       /* -fgraphite */
  OPT_fgraphite_identity = 770,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 771,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 772, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 773, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 774,           /* -fhash-synchronization */
  /* OPT_fhelp = 775, */                     /* -fhelp */
  /* OPT_fhelp_ = 776, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 777,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 778, */                /* -fhonor-std */
  OPT_fhosted = 779,                         /* -fhosted */
  /* OPT_fhuge_objects = 780, */             /* -fhuge-objects */
  OPT_fident = 781,                          /* -fident */
  OPT_fif_conversion = 782,                  /* -fif-conversion */
  OPT_fif_conversion2 = 783,                 /* -fif-conversion2 */
  OPT_filelist = 784,                        /* -filelist */
  OPT_fimplement_inlines = 785,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 786,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 787,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 788,             /* -fimplicit-templates */
  OPT_findirect_classes = 789,               /* -findirect-classes */
  OPT_findirect_dispatch = 790,              /* -findirect-dispatch */
  OPT_findirect_inlining = 791,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 792,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 793,         /* -finhibit-size-directive */
  OPT_finit_character_ = 794,                /* -finit-character= */
  OPT_finit_integer_ = 795,                  /* -finit-integer= */
  OPT_finit_local_zero = 796,                /* -finit-local-zero */
  OPT_finit_logical_ = 797,                  /* -finit-logical= */
  OPT_finit_real_ = 798,                     /* -finit-real= */
  OPT_finline = 799,                         /* -finline */
  OPT_finline_atomics = 800,                 /* -finline-atomics */
  OPT_finline_functions = 801,               /* -finline-functions */
  OPT_finline_functions_called_once = 802,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 803, */            /* -finline-limit- */
  OPT_finline_limit_ = 804,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 805,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 806,         /* -finline-small-functions */
  OPT_finput_charset_ = 807,                 /* -finput-charset= */
  OPT_finstrument_functions = 808,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 809,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 810,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 811,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 812,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 813,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 814,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 815,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 816,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 817,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 818,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 819,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 820, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 821,                    /* -fipa-profile */
  OPT_fipa_pta = 822,                        /* -fipa-pta */
  OPT_fipa_pure_const = 823,                 /* -fipa-pure-const */
  OPT_fipa_ra = 824,                         /* -fipa-ra */
  OPT_fipa_reference = 825,                  /* -fipa-reference */
  OPT_fipa_sra = 826,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 827, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 828,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 829,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 830,              /* -fira-loop-pressure */
  OPT_fira_region_ = 831,                    /* -fira-region= */
  OPT_fira_share_save_slots = 832,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 833,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 834,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 835,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 836,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 837,               /* -fivar-visibility= */
  OPT_fivopts = 838,                         /* -fivopts */
  OPT_fjni = 839,                            /* -fjni */
  ...
  /* OPT_flat_namespace = 847, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 848,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 849,             /* -fleading-underscore */
  OPT_flifetime_dse = 850,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 851,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 852,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 853,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 854,                    /* -flocal-ivars */
  /* OPT_floop_block = 855, */               /* -floop-block */
  /* OPT_floop_flatten = 856, */             /* -floop-flatten */
  /* OPT_floop_interchange = 857, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 858,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 859, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 860,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 861, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 862, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 863,                      /* -flra-remat */
  OPT_flto = 864,                            /* -flto */
  OPT_flto_compression_level_ = 865,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 866,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 867,                 /* -flto-partition= */
  OPT_flto_report = 868,                     /* -flto-report */
  OPT_flto_report_wpa = 869,                 /* -flto-report-wpa */
  OPT_flto_ = 870,                           /* -flto= */
  OPT_fltrans = 871,                         /* -fltrans */
  OPT_fltrans_output_list_ = 872,            /* -fltrans-output-list= */
  OPT_fmain_ = 873,                          /* -fmain= */
  ...
  OPT_fmodulo_sched = 887,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 888,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 889,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 890,                  /* -fms-extensions */
  /* OPT_fmudflap = 891, */                  /* -fmudflap */
  /* OPT_fmudflapir = 892, */                /* -fmudflapir */
  /* OPT_fmudflapth = 893, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 894, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 895, */                  /* -fnew-abi */
  OPT_fnext_runtime = 896,                   /* -fnext-runtime */
  OPT_fnil_receivers = 897,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 898, */       /* -fno-vect-cost-model */
  ...
  OPT_foptimize_static_class_initialization = 923,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 924,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 925, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 926, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 927, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 928,              /* -foutput-class-dir= */
  ...
  OPT_fpcc_struct_return = 933,              /* -fpcc-struct-return */
  OPT_fpch_deps = 934,                       /* -fpch-deps */
  OPT_fpch_preprocess = 935,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 936,                     /* -fpeel-loops */
  OPT_fpeephole = 937,                       /* -fpeephole */
  OPT_fpeephole2 = 938,                      /* -fpeephole2 */
  OPT_fpermissive = 939,                     /* -fpermissive */
  OPT_fpic = 940,                            /* -fpic */
  OPT_fpie = 941,                            /* -fpie */
  ...
  OPT_freduced_reflection = 980,             /* -freduced-reflection */
  OPT_free = 981,                            /* -free */
  ...
  OPT_frtti = 999,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 1000,    /* -fsanitize-coverage=trace-pc */
  ...
  OPT_fsaw_java_file = 1006,                 /* -fsaw-java-file */
  ...
  OPT_fsemantic_interposition = 1036,        /* -fsemantic-interposition */
  OPT_fshort_enums = 1037,                   /* -fshort-enums */
  OPT_fshort_wchar = 1038,                   /* -fshort-wchar */
  OPT_fshow_column = 1039,                   /* -fshow-column */
  OPT_fshrink_wrap = 1040,                   /* -fshrink-wrap */
  OPT_fsign_zero = 1041,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1042,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1043,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1044,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1045,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1046,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1047,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1048,            /* -fsized-deallocation */
  OPT_fsource_filename_ = 1049,              /* -fsource-filename= */
  OPT_fsource_ = 1050,                       /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 1051,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 1052,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1053,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1054,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1055, */                /* -fsquangle */
  OPT_fssa_backprop = 1056,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1057,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1058,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1059,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1060, */             /* -fstack-check */
  OPT_fstack_check_ = 1061,                  /* -fstack-check= */
  OPT_fstack_limit = 1062,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1063,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1064,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1065,               /* -fstack-protector */
  OPT_fstack_protector_all = 1066,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1067,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1068,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1069,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1070,                   /* -fstack-usage */
  OPT_fstats = 1071,                         /* -fstats */
  OPT_fstdarg_opt = 1072,                    /* -fstdarg-opt */
  OPT_fstore_check = 1073,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1074, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1075,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1076,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1077,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1078, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1079,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1080,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1081,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1082,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1083, */             /* -ftarget-help */
  OPT_ftarget_ = 1084,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1085,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1086, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1087,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1088,            /* -fterminated-vtables */
  OPT_ftest_coverage = 1089,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1090, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1091,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1092,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1093,                   /* -ftime-report */
  OPT_ftls_model_ = 1094,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1095,              /* -ftoplevel-reorder */
  OPT_ftracer = 1096,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1097,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1098,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1099,                 /* -ftrapping-math */
  OPT_ftrapv = 1100,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1101,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1102,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1103,                      /* -ftree-ccp */
  OPT_ftree_ch = 1104,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1105, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1106,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1107,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1108, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1109,                   /* -ftree-cselim */
  OPT_ftree_dce = 1110,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1111,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1112,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1113,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1114,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1115, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1116,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1117,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1118,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1119,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1120,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1121, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1122,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1123,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1124,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1125,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1126,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1127,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1128,                      /* -ftree-pre */
  OPT_ftree_pta = 1129,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1130,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1131, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1132,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1133,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1134,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1135,                     /* -ftree-slsr */
  OPT_ftree_sra = 1136,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1137, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1138, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1139,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1140,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1141,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1142, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1143,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1144, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1145,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1146,         /* -funconstrained-commons */
  OPT_funderscoring = 1147,                  /* -funderscoring */
  OPT_funit_at_a_time = 1148,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1149,              /* -funroll-all-loops */
  OPT_funroll_loops = 1150,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1151,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1152,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1153,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1154,                 /* -funsigned-char */
  OPT_funswitch_loops = 1155,                /* -funswitch-loops */
  OPT_funwind_tables = 1156,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1157,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1158,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1159,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1160,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1161,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1162,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1163,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1164,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1165,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1166,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1167,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1168,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1169,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1170, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1171,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1172,                   /* -fverbose-asm */
  /* OPT_fversion = 1173, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1174,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1175,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1176,                   /* -fvisibility= */
  OPT_fvpt = 1177,                           /* -fvpt */
  /* OPT_fvtable_gc = 1178, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1179, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1180,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1181,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1182,                     /* -fvtv-debug */
  OPT_fweak = 1183,                          /* -fweak */
  OPT_fweb = 1184,                           /* -fweb */
  /* OPT_fwhole_file = 1185, */              /* -fwhole-file */
  OPT_fwhole_program = 1186,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1187,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1188,             /* -fworking-directory */
  OPT_fwpa = 1189,                           /* -fwpa */
  OPT_fwpa_ = 1190,                          /* -fwpa= */
  OPT_fwrapv = 1191,                         /* -fwrapv */
  /* OPT_fxref = 1192, */                    /* -fxref */
  /* OPT_fzee = 1193, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1194,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1195,                     /* -fzero-link */
  OPT_g = 1196,                              /* -g */
  OPT_gant = 1197,                           /* -gant */
  OPT_gcoff = 1198,                          /* -gcoff */
  OPT_gdwarf = 1199,                         /* -gdwarf */
  OPT_gdwarf_ = 1200,                        /* -gdwarf- */
  OPT_gen_decls = 1201,                      /* -gen-decls */
  OPT_gfull = 1202,                          /* -gfull */
  OPT_ggdb = 1203,                           /* -ggdb */
  OPT_ggnu_pubnames = 1204,                  /* -ggnu-pubnames */
  OPT_gnat = 1205,                           /* -gnat */
  OPT_gnatO = 1206,                          /* -gnatO */
  OPT_gno_pubnames = 1207,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1208,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1209,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1210,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1211,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1212,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1213,                   /* -gsplit-dwarf */
  OPT_gstabs = 1214,                         /* -gstabs */
  OPT_gstabs_ = 1215,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1216,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1217,                        /* -gtoggle */
  OPT_gused = 1218,                          /* -gused */
  OPT_gvms = 1219,                           /* -gvms */
  OPT_gxcoff = 1220,                         /* -gxcoff */
  OPT_gxcoff_ = 1221,                        /* -gxcoff+ */
  OPT_gz = 1222,                             /* -gz */
  OPT_gz_ = 1223,                            /* -gz= */
  OPT_h = 1224,                              /* -h */
  OPT_headerpad_max_install_names = 1225,    /* -headerpad_max_install_names */
  OPT_idirafter = 1226,                      /* -idirafter */
  OPT_iframework = 1227,                     /* -iframework */
  OPT_imacros = 1228,                        /* -imacros */
  /* OPT_image_base = 1229, */               /* -image_base */
  OPT_imultiarch = 1230,                     /* -imultiarch */
  OPT_imultilib = 1231,                      /* -imultilib */
  OPT_include = 1232,                        /* -include */
  /* OPT_init = 1233, */                     /* -init */
  /* OPT_install_name = 1234, */             /* -install_name */
  OPT_iplugindir_ = 1235,                    /* -iplugindir= */
  OPT_iprefix = 1236,                        /* -iprefix */
  OPT_iquote = 1237,                         /* -iquote */
  OPT_isysroot = 1238,                       /* -isysroot */
  OPT_isystem = 1239,                        /* -isystem */
  OPT_iwithprefix = 1240,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1241,              /* -iwithprefixbefore */
  OPT_k8 = 1242,                             /* -k8 */
  OPT_keep_private_externs = 1243,           /* -keep_private_externs */
  OPT_l = 1244,                              /* -l */
  OPT_lang_asm = 1245,                       /* -lang-asm */
  OPT_m128bit_long_double = 1246,            /* -m128bit-long-double */
  OPT_m16 = 1247,                            /* -m16 */
  OPT_m32 = 1248,                            /* -m32 */
  OPT_m3dnow = 1249,                         /* -m3dnow */
  OPT_m3dnowa = 1250,                        /* -m3dnowa */
  OPT_m64 = 1251,                            /* -m64 */
  OPT_m80387 = 1252,                         /* -m80387 */
  OPT_m8bit_idiv = 1253,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1254,             /* -m96bit-long-double */
  OPT_mabi_ = 1255,                          /* -mabi= */
  OPT_mabm = 1256,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1257,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1258,                 /* -maddress-mode= */
  OPT_madx = 1259,                           /* -madx */
  OPT_maes = 1260,                           /* -maes */
  OPT_malign_data_ = 1261,                   /* -malign-data= */
  OPT_malign_double = 1262,                  /* -malign-double */
  OPT_malign_functions_ = 1263,              /* -malign-functions= */
  OPT_malign_jumps_ = 1264,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1265,                  /* -malign-loops= */
  OPT_malign_stringops = 1266,               /* -malign-stringops */
  OPT_march_ = 1267,                         /* -march= */
  OPT_masm_ = 1268,                          /* -masm= */
  OPT_matt_stubs = 1269,                     /* -matt-stubs */
  OPT_mavx = 1270,                           /* -mavx */
  OPT_mavx2 = 1271,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1272,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1273,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1274,                      /* -mavx512bw */
  OPT_mavx512cd = 1275,                      /* -mavx512cd */
  OPT_mavx512dq = 1276,                      /* -mavx512dq */
  OPT_mavx512er = 1277,                      /* -mavx512er */
  OPT_mavx512f = 1278,                       /* -mavx512f */
  OPT_mavx512ifma = 1279,                    /* -mavx512ifma */
  OPT_mavx512pf = 1280,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1281,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1282,                      /* -mavx512vl */
  OPT_mbmi = 1283,                           /* -mbmi */
  OPT_mbmi2 = 1284,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1285,                  /* -mbranch-cost= */
  OPT_mcld = 1286,                           /* -mcld */
  OPT_mclflushopt = 1287,                    /* -mclflushopt */
  OPT_mclwb = 1288,                          /* -mclwb */
  OPT_mclzero = 1289,                        /* -mclzero */
  OPT_mcmodel_ = 1290,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1291,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1292, */                    /* -mcpu= */
  OPT_mcrc32 = 1293,                         /* -mcrc32 */
  OPT_mcx16 = 1294,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1295,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1296,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1297,                /* -mdynamic-no-pic */
  OPT_mf16c = 1298,                          /* -mf16c */
  OPT_mfancy_math_387 = 1299,                /* -mfancy-math-387 */
  OPT_mfentry = 1300,                        /* -mfentry */
  OPT_mfix_and_continue = 1301,              /* -mfix-and-continue */
  OPT_mfma = 1302,                           /* -mfma */
  OPT_mfma4 = 1303,                          /* -mfma4 */
  OPT_mforce_drap = 1304,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1305,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1306,                       /* -mfpmath= */
  OPT_mfsgsbase = 1307,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1308, */              /* -mfused-madd */
  OPT_mfxsr = 1309,                          /* -mfxsr */
  OPT_mhard_float = 1310,                    /* -mhard-float */
  OPT_mhle = 1311,                           /* -mhle */
  OPT_miamcu = 1312,                         /* -miamcu */
  OPT_mieee_fp = 1313,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1314,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1315,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1316,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1317, */            /* -mintel-syntax */
  OPT_mkernel = 1318,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1319,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1320,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1321,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1322,                /* -mlong-double-80 */
  OPT_mlwp = 1323,                           /* -mlwp */
  OPT_mlzcnt = 1324,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1325,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1326,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1327,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1328,                  /* -mmitigate-rop */
  OPT_mmmx = 1329,                           /* -mmmx */
  OPT_mmovbe = 1330,                         /* -mmovbe */
  OPT_mmpx = 1331,                           /* -mmpx */
  OPT_mms_bitfields = 1332,                  /* -mms-bitfields */
  OPT_mmwaitx = 1333,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1334,            /* -mno-align-stringops */
  OPT_mno_default = 1335,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1336,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1337,                  /* -mno-push-args */
  OPT_mno_red_zone = 1338,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1339,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1340,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1341,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1342,                 /* -mone-byte-bool */
  OPT_mpc32 = 1343,                          /* -mpc32 */
  OPT_mpc64 = 1344,                          /* -mpc64 */
  OPT_mpc80 = 1345,                          /* -mpc80 */
  OPT_mpclmul = 1346,                        /* -mpclmul */
  OPT_mpcommit = 1347,                       /* -mpcommit */
  OPT_mpku = 1348,                           /* -mpku */
  OPT_mpopcnt = 1349,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1350,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1351,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1352,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1353,                        /* -mprfchw */
  OPT_mpush_args = 1354,                     /* -mpush-args */
  OPT_mrdrnd = 1355,                         /* -mrdrnd */
  OPT_mrdseed = 1356,                        /* -mrdseed */
  OPT_mrecip = 1357,                         /* -mrecip */
  OPT_mrecip_ = 1358,                        /* -mrecip= */
  OPT_mrecord_mcount = 1359,                 /* -mrecord-mcount */
  OPT_mred_zone = 1360,                      /* -mred-zone */
  OPT_mregparm_ = 1361,                      /* -mregparm= */
  OPT_mrtd = 1362,                           /* -mrtd */
  OPT_mrtm = 1363,                           /* -mrtm */
  OPT_msahf = 1364,                          /* -msahf */
  OPT_msha = 1365,                           /* -msha */
  OPT_mskip_rax_setup = 1366,                /* -mskip-rax-setup */
  OPT_msoft_float = 1367,                    /* -msoft-float */
  OPT_msse = 1368,                           /* -msse */
  OPT_msse2 = 1369,                          /* -msse2 */
  OPT_msse2avx = 1370,                       /* -msse2avx */
  OPT_msse3 = 1371,                          /* -msse3 */
  OPT_msse4 = 1372,                          /* -msse4 */
  OPT_msse4_1 = 1373,                        /* -msse4.1 */
  OPT_msse4_2 = 1374,                        /* -msse4.2 */
  OPT_msse4a = 1375,                         /* -msse4a */
  /* OPT_msse5 = 1376, */                    /* -msse5 */
  OPT_msseregparm = 1377,                    /* -msseregparm */
  OPT_mssse3 = 1378,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1379,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1380,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1381,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1382,            /* -mstringop-strategy= */
  OPT_mstv = 1383,                           /* -mstv */
  OPT_mtbm = 1384,                           /* -mtbm */
  OPT_mtls_dialect_ = 1385,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1386,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1387,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1388,                         /* -mtune= */
  /* OPT_multi_module = 1389, */             /* -multi_module */
  /* OPT_multiply_defined = 1390, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1391, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1392,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1393,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1394,                    /* -mvzeroupper */
  OPT_mx32 = 1395,                           /* -mx32 */
  OPT_mxop = 1396,                           /* -mxop */
  OPT_mxsave = 1397,                         /* -mxsave */
  OPT_mxsavec = 1398,                        /* -mxsavec */
  OPT_mxsaveopt = 1399,                      /* -mxsaveopt */
  OPT_mxsaves = 1400,                        /* -mxsaves */
  OPT_n = 1401,                              /* -n */
  OPT_no_canonical_prefixes = 1402,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1403,              /* -no-integrated-cpp */
  OPT_no_pie = 1404,                         /* -no-pie */
  /* OPT_no_dead_strip_inits_and_terms = 1405, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1406,                          /* -nocpp */
  OPT_nodefaultlibs = 1407,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1408,                /* -nofixprebinding */
  OPT_nomultidefs = 1409,                    /* -nomultidefs */
  OPT_noprebind = 1410,                      /* -noprebind */
  OPT_noseglinkedit = 1411,                  /* -noseglinkedit */
  OPT_nostartfiles = 1412,                   /* -nostartfiles */
  OPT_nostdinc = 1413,                       /* -nostdinc */
  OPT_nostdinc__ = 1414,                     /* -nostdinc++ */
  OPT_nostdlib = 1415,                       /* -nostdlib */
  OPT_o = 1416,                              /* -o */
  OPT_object = 1417,                         /* -object */
  OPT_p = 1418,                              /* -p */
  OPT_pagezero_size = 1419,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1420,                /* -pass-exit-codes */
  /* OPT_pedantic = 1421, */                 /* -pedantic */
  OPT_pedantic_errors = 1422,                /* -pedantic-errors */
  OPT_pg = 1423,                             /* -pg */
  OPT_pie = 1424,                            /* -pie */
  OPT_pipe = 1425,                           /* -pipe */
  OPT_prebind = 1426,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1427,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1428,                        /* -preload */
  OPT_print_file_name_ = 1429,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1430,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1431,          /* -print-multi-directory */
  OPT_print_multi_lib = 1432,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1433,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1434,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1435,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1436,               /* -print-prog-name= */
  OPT_print_search_dirs = 1437,              /* -print-search-dirs */
  OPT_print_sysroot = 1438,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1439,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1440,                 /* -private_bundle */
  OPT_pthread = 1441,                        /* -pthread */
  OPT_quiet = 1442,                          /* -quiet */
  OPT_r = 1443,                              /* -r */
  OPT_rdynamic = 1444,                       /* -rdynamic */
  OPT_read_only_relocs = 1445,               /* -read_only_relocs */
  OPT_remap = 1446,                          /* -remap */
  OPT_s = 1447,                              /* -s */
  OPT_s_bc_abi = 1448,                       /* -s-bc-abi */
  OPT_save_temps = 1449,                     /* -save-temps */
  OPT_save_temps_ = 1450,                    /* -save-temps= */
  OPT_sectalign = 1451,                      /* -sectalign */
  OPT_sectcreate = 1452,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1453,              /* -sectobjectsymbols */
  OPT_sectorder = 1454,                      /* -sectorder */
  OPT_seg1addr = 1455,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1456, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1457, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1458, */                  /* -segaddr */
  OPT_segcreate = 1459,                      /* -segcreate */
  OPT_seglinkedit = 1460,                    /* -seglinkedit */
  OPT_segprot = 1461,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1462, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1463, */     /* -segs_read_write_addr */
  OPT_shared = 1464,                         /* -shared */
  OPT_shared_libgcc = 1465,                  /* -shared-libgcc */
  /* OPT_single_module = 1466, */            /* -single_module */
  /* OPT_specs = 1467, */                    /* -specs */
  OPT_specs_ = 1468,                         /* -specs= */
  OPT_static = 1469,                         /* -static */
  OPT_static_libasan = 1470,                 /* -static-libasan */
  OPT_static_libgcc = 1471,                  /* -static-libgcc */
  OPT_static_libgcj = 1472,                  /* -static-libgcj */
  OPT_static_libgfortran = 1473,             /* -static-libgfortran */
  OPT_static_libgo = 1474,                   /* -static-libgo */
  OPT_static_liblsan = 1475,                 /* -static-liblsan */
  OPT_static_libmpx = 1476,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1477,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1478,               /* -static-libstdc++ */
  OPT_static_libtsan = 1479,                 /* -static-libtsan */
  OPT_static_libubsan = 1480,                /* -static-libubsan */
  /* OPT_std_c__03 = 1481, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1482, */                /* -std=c++0x */
  OPT_std_c__11 = 1483,                      /* -std=c++11 */
  OPT_std_c__14 = 1484,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1485, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1486, */                /* -std=c++1y */
  OPT_std_c__1z = 1487,                      /* -std=c++1z */
  OPT_std_c__98 = 1488,                      /* -std=c++98 */
  OPT_std_c11 = 1489,                        /* -std=c11 */
  /* OPT_std_c1x = 1490, */                  /* -std=c1x */
  /* OPT_std_c89 = 1491, */                  /* -std=c89 */
  OPT_std_c90 = 1492,                        /* -std=c90 */
  OPT_std_c99 = 1493,                        /* -std=c99 */
  /* OPT_std_c9x = 1494, */                  /* -std=c9x */
  OPT_std_f2003 = 1495,                      /* -std=f2003 */
  OPT_std_f2008 = 1496,                      /* -std=f2008 */
  OPT_std_f2008ts = 1497,                    /* -std=f2008ts */
  OPT_std_f95 = 1498,                        /* -std=f95 */
  OPT_std_gnu = 1499,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1500, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1501, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1502,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1503,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1504, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1505, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1506,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1507,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1508,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1509, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1510, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1511,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1512,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1513, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1514, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1515,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1516, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1517, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1518, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1519,                     /* -std=legacy */
  OPT_sub_library = 1520,                    /* -sub_library */
  OPT_sub_umbrella = 1521,                   /* -sub_umbrella */
  OPT_symbolic = 1522,                       /* -symbolic */
  OPT_t = 1523,                              /* -t */
  OPT_time = 1524,                           /* -time */
  OPT_time_ = 1525,                          /* -time= */
  OPT_traditional = 1526,                    /* -traditional */
  OPT_traditional_cpp = 1527,                /* -traditional-cpp */
  OPT_trigraphs = 1528,                      /* -trigraphs */
  OPT_twolevel_namespace = 1529,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1530,       /* -twolevel_namespace_hints */
  OPT_u = 1531,                              /* -u */
  /* OPT_umbrella = 1532, */                 /* -umbrella */
  OPT_undef = 1533,                          /* -undef */
  OPT_undefined = 1534,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1535, */  /* -unexported_symbols_list */
  OPT_v = 1536,                              /* -v */
  OPT_version = 1537,                        /* -version */
  OPT_w = 1538,                              /* -w */
  /* OPT_weak_reference_mismatches = 1539, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1540,                    /* -whatsloaded */
  OPT_whyload = 1541,                        /* -whyload */
  OPT_wrapper = 1542,                        /* -wrapper */
  OPT_x = 1543,                              /* -x */
  OPT_y = 1544,                              /* -y */
  OPT_z = 1545,                              /* -z */
  N_OPTS,
