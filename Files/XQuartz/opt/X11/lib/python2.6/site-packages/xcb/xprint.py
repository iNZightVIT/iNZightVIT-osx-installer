...
class PrintGetPrinterListReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.listCount,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.printers = xcb.List(parent, offset, self.listCount, PRINTER, -1)
...
class PrintGetContextReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.context,) = unpack_from('xx2x4xI', parent, offset)
...
class PrintGetScreenOfContextReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.root,) = unpack_from('xx2x4xI', parent, offset)
...
class PrintGetDocumentDataReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.status_code, self.finished_flag, self.dataLen,) = unpack_from('xx2x4xIII12x', parent, offset)
        offset += 32
...
class PrintInputSelectedReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        ...
        offset += 12
        self.event_list = xcb.List(parent, offset, xcb.popcount(self.event_mask), 'I', 4)
        offset += len(self.event_list.buf())
        (self.all_events_mask,) = unpack_from('I', parent, offset)
        offset += 4
        offset += xcb.type_pad(4, offset)
        self.all_events_list = xcb.List(parent, offset, xcb.popcount(self.all_events_mask), 'I', 4)
...
class PrintGetAttributesReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.stringLen,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.attributes = xcb.List(parent, offset, self.stringLen, 'b', 1)
...
class PrintGetOneAttributesReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.valueLen,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.value = xcb.List(parent, offset, self.valueLen, 'b', 1)
...
class PrintGetPageDimensionsReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.width, self.height, self.offset_x, self.offset_y, self.reproducible_width, self.reproducible_height,) = unpack_from('xx2x4xHHHHHH', parent, offset)
...
class PrintQueryScreensReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        ...
        (self.listCount,) = unpack_from('xx2x4xI20x', parent, offset)
        offset += 32
        self.roots = xcb.List(parent, offset, self.listCount, 'I', 4)
...
class PrintSetImageResolutionReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.status, self.previous_resolutions,) = unpack_from('xB2x4xH', parent, offset)
...
class PrintGetImageResolutionReply(xcb.Reply):
    def __init__(self, parent, offset=0):
        xcb.Reply.__init__(self, parent, offset)
        (self.image_resolution,) = unpack_from('xx2x4xH', parent, offset)

class NotifyEvent(xcb.Event):
    def __init__(self, parent, offset=0):
        xcb.Event.__init__(self, parent, offset)
        (self.detail, self.context, self.cancel,) = unpack_from('xB2xIB', parent, offset)

class AttributNotifyEvent(xcb.Event):
    def __init__(self, parent, offset=0):
        xcb.Event.__init__(self, parent, offset)
        (self.detail, self.context,) = unpack_from('xB2xI', parent, offset)
