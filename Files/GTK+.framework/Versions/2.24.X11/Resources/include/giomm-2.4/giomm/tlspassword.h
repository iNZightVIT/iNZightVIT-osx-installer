...
protected:
    explicit TlsPassword(TlsPasswordFlags flags, const Glib::ustring& description);
...
public:
  ...
  static Glib::RefPtr<TlsPassword> create(TlsPasswordFlags flags, const Glib::ustring& description);
