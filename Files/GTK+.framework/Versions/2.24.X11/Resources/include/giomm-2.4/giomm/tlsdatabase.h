...
public:
   ...
   * @newin{2,30}
   * @param result A AsyncResult.
   * @return A newly allocated list of TlsCertificate objects.
   * Use Glib::object_unref() on each certificate, and Glib::list_free() on the release the list.
   */
  ...
  /// @throws Glib::Error.
  virtual TlsCertificateFlags verify_chain_vfunc(const Glib::RefPtr<TlsCertificate>& chain, const Glib::ustring& purpose, const Glib::RefPtr<const SocketConnectable>& identity, const Glib::RefPtr<TlsInteraction>& interaction, const Glib::RefPtr<Cancellable>& cancellable, TlsDatabaseVerifyFlags flags);

    virtual void verify_chain_async_vfunc(const Glib::RefPtr<TlsCertificate>& chain, const Glib::ustring& purpose, const Glib::RefPtr<const SocketConnectable>& identity, const Glib::RefPtr<TlsInteraction>& interaction, const SlotAsyncReady& slot, const Glib::RefPtr<Cancellable>& cancellable, TlsDatabaseVerifyFlags flags);
  ...
  virtual TlsCertificateFlags verify_chain_finish_vfunc(const Glib::RefPtr<AsyncResult>& result);
    ...
    virtual Glib::ustring create_certificate_handle_vfunc(const Glib::RefPtr<TlsCertificate>& certificate) const;
