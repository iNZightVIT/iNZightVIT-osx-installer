...
public:
   ...
   */
  void set_require_close_notify(bool require_close_notify);
   ...
   * TLS <tt>renegotiation_info</tt> extension. This is the
   ...
   * <tt>renegotiation_info</tt> extension. On the server side
   ...
   */
  void set_use_system_certdb(bool use_system_certdb);
   ...
   * 
   * @newin{2,28}
   * @param io_priority The I/O priority
   * of the request.
   * @param cancellable A Cancellable, or <tt>0</tt>.
